...
const ResultCard: React.FC<ResultCardProps> = ({ language, data, borderColor }) => {
  ...
  return (
    <div className="relative">
      ...
      {/* Expandable content - positioned absolutely to not affect layout */}
      {isExpanded && (
        <div className="absolute top-full left-0 right-0 z-10 mt-2 bg-slate-800/90 backdrop-blur-sm p-4 sm:p-6 rounded-lg shadow-xl border border-slate-600/30 animate-in slide-in-from-top-2 duration-200">
